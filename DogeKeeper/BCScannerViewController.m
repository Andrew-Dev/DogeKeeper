...
- (void)viewDidLoad
{
    ...
    //Edited by Andrew Arpasi - adding cancel button and UI labels
    CGRect screenRect = [[UIScreen mainScreen] bounds];
	UIButton * cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(0, screenRect.size.height-80, 128, 64)];
    [cancelButton setTitle:@"Cancel" forState:UIControlStateNormal];
    [cancelButton setTintColor:[UIColor whiteColor]];
    [cancelButton addTarget:self action:@selector(dismissScanner) forControlEvents:UIControlEventAllEvents];
    [self.view addSubview:cancelButton];
    UILabel * qrlabel = [[UILabel alloc] initWithFrame:CGRectMake(32, 32, 256, 32)];
    qrlabel.text = @"Scan a QR Code";
    [qrlabel setTextColor:[UIColor whiteColor]];
    [qrlabel setTextAlignment:NSTextAlignmentCenter];
    [self.view addSubview:qrlabel];
    //end Andrew Arpasi edits
